...
<br /> 
 		...
 		<p class="sh2"><b>Initiative</b></p>
			...
			<p>
				...
				<g:textArea name="description" placeholder="The overall goal of the Code Review practice is quality control. Those performing code review must ensure the detection and correction of security bugs. The SSG must enforce adherence to standards and the reuse of approved security features." rows="5" cols="400"/>	
			</p>
